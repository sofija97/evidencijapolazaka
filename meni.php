...
?>
                                <li>
                                    <a href="administracijaLinija.php">Obrada linija</a>
                                </li>
                                <li>
                                    <a href="administracijaPolazaka.php">Obrada polaska</a>
                                </li>
                                <li>
                                    <a href="upravljanjeKorisnicima.php">Upravljanje polascima</a>
                                </li>
                    <?php
                            }
                            ?>
